## Cuisine-connect
- Ce projet est définit en N features principales:
    - Une recherche grâce à l'IA dans ma base de données. La ou les recette(s) disponbiles en fonctions des mots clés fournies.
